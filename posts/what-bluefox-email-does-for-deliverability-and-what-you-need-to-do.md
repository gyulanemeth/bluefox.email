...
When you send a transactional email, triggered email, campaign or automation email, BlueFox processes the request and submits the message through the configured sending infrastructure.
