...
![AWS can be scary.](./how-to-set-up-aws-ses/00.webp)
...
![AWS SES console homepage with the menu highlighted](./how-to-set-up-aws-ses/01.webp)
...
![SES menu showing account dashboard and get set up options](./how-to-set-up-aws-ses/02.webp)
...
![SES account dashboard showing sandbox status](./how-to-set-up-aws-ses/03.webp)
...
![SES email address verification input field](./how-to-set-up-aws-ses/04.webp)
...
![Sending domain information setup screen in SES](./how-to-set-up-aws-ses/05.webp)
...
![SES sender domain input field](./how-to-set-up-aws-ses/06.webp)
...
![MAIL FROM subdomain configuration screen in SES](./how-to-set-up-aws-ses/07.webp)
...
![SES setup summary page with a get started button](./how-to-set-up-aws-ses/09.webp)
...
![Email from AWS SES for address verification](./how-to-set-up-aws-ses/10.webp)
...
![Confirmation message for successful email verification in SES](./how-to-set-up-aws-ses/11.webp)
...
![SES completed tasks section showing verified email address](./how-to-set-up-aws-ses/12.webp)
...
![SES send test email button in open tasks section](./how-to-set-up-aws-ses/13.webp)
...
![Test email form in SES with fields for custom settings](./how-to-set-up-aws-ses/14.webp)

You’ll find "Custom" at the end of the dropdown.

![Dropdown menu in SES showing custom option at the bottom](./how-to-set-up-aws-ses/15.webp)

**13) Verify that you received the test email.** Here’s how mine looks:

![Test email example received from AWS SES](./how-to-set-up-aws-ses/16.webp)
...
![Email header showing signed-by and mailed-by fields](./how-to-set-up-aws-ses/17.webp)
...
![SES get DNS records button in open tasks section](./how-to-set-up-aws-ses/18.webp)

**15) Set up the provided DNS records at your DNS provider.** These include **DKIM**, **DMARC**, and optional **MAIL FROM** records.

![DNS records list provided by SES for domain verification](./how-to-set-up-aws-ses/19.webp)
...
![SES completed tasks section showing verified domain](./how-to-set-up-aws-ses/21.webp)
...
![SES production access request button](./how-to-set-up-aws-ses/22.webp)
