...
Email providers like Gmail, Yahoo, and Microsoft apply their own internal thresholds, but generally align with these industry standards. AWS SES specifically enforces a 5% maximum bounce rate for [production sending](/aws-concepts/production-access.md), accounts exceeding this face potential review and restrictions.
