...
To minimize soft [bounce rates](/email-sending-concepts/bounce-rate), segment your lists by engagement level, respect recipient server limitations, avoid unnecessarily large attachments, implement proper authentication ([SPF](/email-sending-concepts/spf), [DKIM](/email-sending-concepts/dkim), [DMARC](/email-sending-concepts/dmarc)), and monitor your sending infrastructure for performance issues that could contribute to higher soft bounce rates.
