...
import { mdiMagnify, mdiClose, mdiAlertCircleOutline, mdiCheck, mdiAlertOutline, mdiInformationOutline, mdiChevronDown, mdiContentCopy } from '@mdi/js'
    ...
    <div v-if="result" class="results" ref="resultsRef">
      ...
      <div class="hero" :class="result.valid && result.record ? 'hero-pass' : 'hero-fail'">
        <div class="hero-icon" :class="result.valid && result.record ? 'icon-pass' : 'icon-fail'">
          <svg v-if="result.valid && result.record" width="28" height="28" viewBox="0 0 24 24"><path :d="mdiCheck" fill="currentColor"/></svg>
              ...
              <div class="tag-row" v-for="tag in dkimTags" :key="tag.tag">
                ...
                <div class="tag-main">
                  <div class="tag-value-line">
                    ...
                    >
                      <svg v-if="copiedTag === tag.tag" width="13" height="13" viewBox="0 0 24 24"><path :d="mdiCheck" fill="currentColor"/></svg>
                      <svg v-else width="13" height="13" viewBox="0 0 24 24"><path :d="mdiContentCopy" fill="currentColor"/></svg>
