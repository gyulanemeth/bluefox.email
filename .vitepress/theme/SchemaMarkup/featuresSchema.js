...
const FEATURE_LIST = [
  ...
  'Automation Triggers',
  'Audience Filter & Branching',
  'Automation Actions',
  'Timers & Exit Criteria',
  'Visual Email Builder',
  'Email Themes (Atomic Design System)',
  'Per-Project Theme Overrides',
  'Predesigned Templates',
  'Merge Tags & Handlebars',
  'Image & Button Personalization',
  'Conditionals',
  'Loops & String Helpers',
  'Email Performance Metrics',
  'Bounce & Complaint Tracking',
  'Subscription Metrics',
  'Charts, Filters & CSV Export',
  'Suppression Lists',
  'Unengaged Contact Exclusion',
  'Bounce & Complaint Cleanup',
  'Sandbox Mode',
  'Production Mode',
  'BYO AWS SES',
  'HTTP API',
