...
<template>
  <PersonaLanding
    ...
    design-description="Without shared components, templates drift and every campaign introduces inconsistencies. Build a modular design system for your lifecycle emails, then reuse it safely across every product stream without rebuilding from scratch."
    automation-title="Automate and Segment Without Engineering Overhead"
    automation-description="Onboarding sequence changes shouldn't sit in sprint queues. Build segments with AND/OR conditions on any contact property, then use them as audience filters in lifecycle flows. Branching logic, targeting precision, and no engineering ticket required."
    analytics-title="Email Analytics for Product Teams"
    analytics-description="Email events often stay siloed from your product. Track engagement, delivery health, and subscription trends in one place so product and growth teams can optimize journeys based on outcomes, not guesswork."
