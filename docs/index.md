...
description: Learn how to manage email production, client projects, and deliverability at scale, built specifically for marketing agencies using BlueFox Email’s advanced tools.
head:
  - - meta
    - name: description
      content: Learn how to manage email production, client projects, and deliverability at scale, built specifically for marketing agencies using BlueFox Email’s advanced tools.
  - - meta
    - property: og:title
