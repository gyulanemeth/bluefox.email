...
bluefox.email includes a powerful drag-and-drop email editor for building responsive, branded emails. It supports real-time multi-user editing, a full library of content and advanced elements, complete mobile control, and deep personalization — all without writing HTML.
...
The editor is a multi-user, simultaneous editing environment. Multiple team members can work on the same email template at the same time, with changes reflected in real time — similar to how Google Docs works for documents.
...
- [How real-time editing works](https://help.chamaileon.io/en/articles/3472755-what-is-real-time-editing-and-how-it-works) — how simultaneous multi-user editing is handled.
...
The editor includes an AI assistant for email copy edits. Select any text element and use the AI assistant to rewrite, shorten, expand, adjust tone, or fix grammar — directly inside the editor without switching tools.

**Related guides:**
- [AI assistant for email copy edits](https://help.chamaileon.io/en/articles/11331624-ai-assistant-for-email-copy-edits) — rewrite, shorten, expand, and adjust tone on any text selection.

---

## Convert Document

The Convert Document function imports an existing document (such as a Word or Google Doc export) and converts its content into an editable email template structure. Useful for migrating existing email content into the visual editor.

**Related guides:**
- [Convert Document function](https://help.chamaileon.io/en/articles/8717065-convert-document-function) — import a Word or Google Doc and turn it into an editable template.

---

## Landing Pages

The editor supports creating and exporting landing pages in addition to email templates. Build a landing page with the same drag-and-drop tools and export the HTML for hosting anywhere.

**Related guides:**
- [Create and export landing pages](https://help.chamaileon.io/en/articles/12540979-create-and-export-landing-pages-in-chamaileon) — build a landing page with the editor and export the HTML for hosting.
