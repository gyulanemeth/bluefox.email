...
- **[Bounces](/email-sending-concepts/bounces.md)**: The number of emails that failed to be delivered, helping to track deliverability issues.
- **[Complaints](/email-sending-concepts/complaints.md)**: The number of recipients who marked your emails as spam or filed complaints, an important indicator of email content quality.
