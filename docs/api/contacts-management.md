...
:::info
You can pass values for [contact custom properties](/docs/projects/settings#contact-properties) inside the `data` field in the request body. Just make sure the keys match the custom property API names defined in your project settings.
:::
