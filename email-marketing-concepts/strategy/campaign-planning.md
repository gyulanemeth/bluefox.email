---
title: Campaign Planning in Email Marketing
description: Campaign planning covers setting campaign objectives, choosing timing and frequency, and mapping the customer journey so each email arrives with the right message at the right moment.
---

# Campaign Planning in Email Marketing

**Campaign planning** is the process of deciding what to send, why, and when — turning a broad [email marketing strategy](/email-marketing-concepts/strategy/) into a concrete sequence of sends with clear objectives. It sits between [goal setting](/email-marketing-concepts/strategy/goal-setting) (the destination) and execution (the actual emails), acting as the map that connects the two.
...
1. **Send time**: the day and hour a specific email goes out, usually optimized around when your audience is most likely to engage — informed by past open and click data rather than generic "best time to send" advice.
2. **Frequency**: how often your audience hears from you overall, across all campaigns and automations combined. Frequency needs to be planned at the program level, not per-campaign, since audiences can receive a promotional campaign, a newsletter, and a [triggered email](/docs/projects/triggered-emails) in the same week without anyone tracking the cumulative volume.

Frequency that's too low lets the relationship go cold; frequency that's too high increases unsubscribes and spam complaints, directly affecting [deliverability](/email-marketing-concepts/deliverability/).
...
Not every email needs to be individually planned. Recurring, trigger-based sends — welcome sequences, abandoned action reminders, renewal reminders — belong in [automation](/email-marketing-concepts/automation/) rather than a manual campaign calendar. Good campaign planning explicitly accounts for what automations are already running, so a manually planned campaign doesn't collide with or duplicate an automated one hitting the same subscriber.

## Related Content

- [Email Marketing Strategy](/email-marketing-concepts/strategy/)
- [Goal Setting](/email-marketing-concepts/strategy/goal-setting)
- [Content Strategy](/email-marketing-concepts/strategy/content-strategy)
